...
#include "../../3rdparty/utils/common.h"
...
typedef struct {
    rknn_context rknn_ctx;  //ģ�;��
    rknn_input_output_num io_num;   //�������ͨ������YOLOv8����ͨ��Ϊ1�����ͨ��Ϊ3��
...
#endif
    int model_channel;  //����ͼ�����ɫͨ��������1��ʾ��ɫ��3��ʾ��ɫ��
    int model_width;
    int model_height;
    bool is_quant;  //ģ���Ƿ񾭹���INT8����
} rknn_app_context_t;
